          ...
          <div className="container grid gap-6 px-4 md:px-6 lg:grid-cols-2 lg:gap-12 xl:gap-20">
            <div className="space-y-4">
              ...
              <p className="max-w-[600px] text-muted-foreground md:text-xl">
                Master the fundamentals of data structures and algorithms to
                solve complex programming problems and build efficient software
                applications. This course covers a wide range of topics, from
                the basics of arrays and linked lists to advanced algorithms
                like dynamic programming and graph traversal.
              </p>
              <div className="flex flex-col gap-2 min-[400px]:flex-row">
                <Link
                  href="#"
                  className="inline-flex h-10 items-center justify-center rounded-md bg-green-950 hover:bg-green-950 px-8 text-sm font-medium text-primary-foreground shadow transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
                  prefetch={false}
                >
                  Enroll Now
                </Link>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl sm:text-lg">
                  This course covers a wide range of topics, including the core
                  concepts of data structures and algorithms, common algorithms
                  and data structures, and best practices for solving complex
            ...
            <div className="mx-auto grid max-w-5xl items-start gap-6 md:grid-cols-2 lg:grid-cols-3 lg:gap-12">
              <div className="grid gap-1">
                ...
                <p className="text-muted-foreground text-lg">
                  Learn the basics of data structures, including arrays, linked
              ...
              <div className="grid gap-1">
                ...
                <p className="text-muted-foreground text-lg">
                  Dive deeper into advanced data structures and algorithms like
                  trees, graphs, and dynamic programming.
                </p>
              </div>
              <div className="grid gap-1">
                <h3 className="text-xl font-bold">Data structure Ecosystem</h3>
                <p className="text-muted-foreground text-lg">
                  Understand the ecosystem of data structures and algorithms,
                  including common algorithms and data structures.
                </p>
              </div>
              <div className="grid gap-1">
                <h3 className="text-xl font-bold">Project-based Learning</h3>
                <p className="text-muted-foreground text-xl">
                  Apply your knowledge to real-world projects and build
              ...
              <div className="grid gap-1">
                ...
                <p className="text-muted-foreground text-xl">
                  Learn best practices for solving complex programming problems
              ...
              <div className="grid gap-1">
                ...
                <p className="text-muted-foreground text-lg">
                  Understand how to deploy and host your software applications
